 ...
 * @param {object} data individual transaction data object
 *
 */
...
export const getDisplayValue = (value, column) => {
  ...
  if (typeof value === "number") {
    let display = value.toLocaleString(undefined, { maximumFractionDigits: 8 });
    if (column === "amountFiat") {
      // make sure that after all these type conversions USD prices still look right
