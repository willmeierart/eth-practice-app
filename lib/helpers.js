...
// The actual method that filters transactions based on a searchphrase
...
// The actual method that filters transactions based on active filters
// Applied in both the filter and (if applicable) search reducers
export const doFilter = (filters, filter, txs) => {
